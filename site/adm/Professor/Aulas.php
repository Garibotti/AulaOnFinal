    	...
    	<input type="hidden" id="professor" value="<?php echo $idProfessor?>" />
    		<div id="tabs">
    			...
    			<div id="tabs-2">
	    			<div class="conteudoDados">
	    				<div class="conteudoDadosSuperior">
	    					<label for="Novo Curso">Escolha o(s) curso(s) superior(es) no(s) qual(is) a disciplina pertence:</label>			    			
			    			<?php 
					...
					<div class="conteudoBotao">
						<button id="confirmarGeral">Confirmar</button>
					</div>
				</div>
    			...
    			<div id="tabs-3">
    				...
    				<div class="conteudoDados">
	    				<div class="conteudoDadosSuperior">
	    					<label for="Novo Curso">Digite palavras-chaves para descrever o conteúdo da aula e pressiona cadastrar</label>			    			
					...
					<div class="conteudoInterativa">
						<div class="conteudoInterativaSuperior">
							<label for="Cadeira">Palavras-Chaves Escolhidas(Máximo 4 palavras)</label>
					...
					<div class="conteudoBotao">
						<button id="confirmarNovaAula">Confirmar</button>
					</div>
    			</div>
			</div>
		</div>
